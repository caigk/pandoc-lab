...
$template = file_get_contents(__DIR__."/../sample/pandocTemplate_mustache.tex");
$content = $m->render($template, $fields);

echo $content;
file_put_contents("out/{$outfilename}.tex", $content);
...
$commands = array(
    'pdf'=>"pandoc --pdf-engine=xelatex -t {$outFormat}",
    'docx'=>"pandoc  -s -t {$outFormat}"
);
